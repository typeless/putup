...
- discharge: test "Scenario: A glob whose producer is parsed first is not rejected"

If a glob's match set would change once every Tupfile has been parsed, then putup shall reject
the project rather than build it.
