...
description: Writing dual-mode Tupfiles for standalone and component builds. Use when writing reusable libraries, using the self-contained library convention, setting up multi-library projects, or running putup parse --strict.
---
...
## Verifying with `putup parse --strict`

Run the convention checker to catch violations before they cause composed-mode failures:
...
- [ ] `putup parse --strict` reports no errors
